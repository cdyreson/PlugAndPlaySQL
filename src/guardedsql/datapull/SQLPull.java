...
public class SQLPull {
    ...
    public String writeToFile(String queryorderby, HashMap<String, Integer> temp, HashMap<Integer, Set<ForeignKey>> allPaths) throws IOException {
        StringBuilder sb = new StringBuilder();
        String directoryName = "D:/Projects/GaurdedSQL/generatedFiles/query.txt";
