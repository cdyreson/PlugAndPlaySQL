...
public interface SQLiteListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SQLiteParser#outer_guard_clause}.
	 * @param ctx the parse tree
	 */
	void enterOuter_guard_clause(SQLiteParser.Outer_guard_clauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLiteParser#outer_guard_clause}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterGuard_comma(SQLiteParser.Guard_commaContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLiteParser#guard_comma}.
	 * @param ctx the parse tree
	 */
	void exitGuard_comma(SQLiteParser.Guard_commaContext ctx);
	/**
	 * Enter a parse tree produced by {@link SQLiteParser#opening_brace}.
	 * @param ctx the parse tree
	 */
	void enterOpening_brace(SQLiteParser.Opening_braceContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLiteParser#opening_brace}.
	 * @param ctx the parse tree
	 */
	void exitOpening_brace(SQLiteParser.Opening_braceContext ctx);
	/**
	 * Enter a parse tree produced by {@link SQLiteParser#closing_brace}.
	 * @param ctx the parse tree
	 */
	void enterClosing_brace(SQLiteParser.Closing_braceContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLiteParser#closing_brace}.
	 * @param ctx the parse tree
	 */
	void exitClosing_brace(SQLiteParser.Closing_braceContext ctx);
	/**
